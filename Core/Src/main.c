...
int main(void)
{
  ...
  const int player1_button = BT10_GPIO_Port;
  	  const int player1_buttonPin = BT10_Pin;
  	  const int player1_led_port = LED10_GPIO_Port;
  	  const int player1_led_pin = LED10_Pin;



  	  const int player2_button = BT8_GPIO_Port;
  	  	  const int player2_buttonPin = BT8_Pin;
  	  	  const int player2_led_port = LED8_GPIO_Port;
  	  	  const int player2_led_pin = LED8_Pin;
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LED8_Pin|GPIO_PIN_1|LED10_Pin|GPIO_PIN_9, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED8_Pin PA1 LED10_Pin PA9 */
  GPIO_InitStruct.Pin = LED8_Pin|GPIO_PIN_1|LED10_Pin|GPIO_PIN_9;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : BT8_Pin BT10_Pin */
  GPIO_InitStruct.Pin = BT8_Pin|BT10_Pin;
